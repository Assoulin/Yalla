...
import com.example.yalla.databinding.HotRestaurantItemBinding
...
class HotRestaurantsAdapter(
   ...
   // private val onHotRestClicked: (RestaurantForRv) -> Unit
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HotRestaurantsViewHolder {
        ...
        val binding = HotRestaurantItemBinding.inflate(inflater, parent, false)
...
class HotRestaurantsViewHolder(val binding: HotRestaurantItemBinding) :
